!(function () {
      ...
      var n = {},
        ...
        o = (r.WordArray = s.extend({
          ...
          concat: function (t) {
            ...
            else if (65535 < n.length) for (i = 0; i < t; i += 4) e[(r + i) >>> 2] = n[i >>> 2];
    ...
    var t = e,
      ...
      n = (t.algo.SHA1 = i.extend({
        ...
        _doProcessBlock: function (t, e) {
          for (var n = this._hash.words, r = n[0], i = n[1], o = n[2], a = n[3], c = n[4], h = 0; 80 > h; h++) {
            if (16 > h) s[h] = 0 | t[e + h];
            else {
    ...
    (function () {
      ...
      t.algo.HMAC = t.lib.Base.extend({
        init: function (t, e) {
          ...
          for (
            var s = (this._oKey = e.clone()), o = (this._iKey = e.clone()), a = s.words, c = o.words, h = 0;
            h < r;
            h++
          )
  ...
  var n = function (t) {
      ...
      var a = parseInt(Math.random() * Math.pow(2, 32)),
        ...
        f = 'a=' + s + '&b=' + i + '&k=' + t.SecretId + '&e=' + h + '&t=' + c + '&r=' + a + '&f=' + u,
    ...
    r = function (r) {
      ...
      var i = r.SecretId,
        ...
        y = p + ';' + d,
        v = p + ';' + d,
        m = f(c).join(';').toLowerCase(),
        _ = f(a).join(';').toLowerCase(),
