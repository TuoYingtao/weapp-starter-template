import { variantGetParameter, variantGetBracket, variantParentMatcher, variantMatcher } from './utils.mjs';
import { d as h, r as resolveBreakpoints, t as getBracket, C as CONTROL_MINI_NO_NEGATIVE, w as cssMathFnRE } from './shared/unocss-preset-weapp.081deb7c.mjs';
import { warnOnce, escapeRegExp, escapeSelector } from '@unocss/core';
import { hasThemeFn, transformThemeFn, getStringComponent } from '@unocss/rule-utils';
