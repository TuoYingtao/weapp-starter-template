...
import { PresetOptions } from '@unocss/core';
export { t as theme } from './shared/unocss-preset-weapp.8f7635f4.cjs';
export { colors } from './colors.cjs';
export { p as parseColor } from './shared/unocss-preset-weapp.eeba7c36.cjs';
export { a as Theme, T as ThemeAnimation } from './shared/unocss-preset-weapp.4492eb27.cjs';
...
declare const presetWeapp: _unocss_core.PresetFactory<object, PresetWeappOptions>;

export { type DarkModeSelectors, type PresetWeappOptions, presetWeapp as default, presetWeapp };
