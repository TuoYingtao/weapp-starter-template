...
const filters = require('./shared/unocss-preset-weapp.640c88d4.cjs');
require('./shared/unocss-preset-weapp.d6f74a4e.cjs');
require('@unocss/core');
...
const preflightBase = {
  ...filters.transformBase,
  ...filters.boxShadowsBase,
  ...filters.ringBase,
  ...filters.filterBase,
  ...filters.backdropFilterBase
};
