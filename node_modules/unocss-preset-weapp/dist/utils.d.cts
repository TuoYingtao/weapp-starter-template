...
export { C as CONTROL_MINI_NO_NEGATIVE, c as colorResolver, a as colorableShadows, d as directionSize, g as getBracket, e as getComponent, f as getComponents, h as hasParseableColor, i as isCSSMathFn, j as isSize, m as makeGlobalStaticRules, p as parseColor, r as resolveBreakpoints, b as resolveVerticalBreakpoints, s as splitShorthand } from './shared/unocss-preset-weapp.eeba7c36.cjs';
import './shared/unocss-preset-weapp.4492eb27.cjs';
...
declare const handler: _unocss_rule_utils.ValueHandler<"number" | "auto" | "position" | "numberWithUnit" | "rem" | "remToRpx" | "rpx" | "px" | "percent" | "fraction" | "bracket" | "bracketOfColor" | "bracketOfLength" | "bracketOfPosition" | "cssvar" | "time" | "degree" | "global" | "properties">;
declare const h: _unocss_rule_utils.ValueHandler<"number" | "auto" | "position" | "numberWithUnit" | "rem" | "remToRpx" | "rpx" | "px" | "percent" | "fraction" | "bracket" | "bracketOfColor" | "bracketOfLength" | "bracketOfPosition" | "cssvar" | "time" | "degree" | "global" | "properties">;
...
export { colorOpacityToString, colorToString, cornerMap, cssMathFnRE, directionMap, globalKeywords, h, handler, hex2rgba, insetMap, parseCssColor, positionMap, handlers as valueHandlers, variantGetBracket, variantGetParameter, variantMatcher, variantParentMatcher, xyzMap };
