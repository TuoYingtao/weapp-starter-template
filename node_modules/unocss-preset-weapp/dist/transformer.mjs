...
import { extractorAttributify as extractorAttributify$1 } from 'unplugin-attributify-to-class/utils';
...
function transformer(options = {}) {
  ...
  const extractor = extractorAttributify$1(options);
  return {
