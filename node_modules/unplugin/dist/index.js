...
function guessIdLoader(id) {
  return ExtToLoader2[import_node_path.default.extname(id).toLowerCase()] || "js";
}
  ...
  if (plugin.resolveId) {
    ...
    farmPlugin.resolve = {
      ...
      async executor(params, context) {
        const resolvedIdPath = import_node_path2.default.resolve(
          process.cwd(),
          params.importer ?? ""
        );
        let isEntry = false;
...
// src/rspack/index.ts
var TRANSFORM_LOADER = (0, import_path5.resolve)(
  __dirname,
  false ? "../../dist/rspack/loaders/transform.js" : "rspack/loaders/transform"
);
var LOAD_LOADER = (0, import_path5.resolve)(
  __dirname,
...
function createBuildContext3(options, compilation) {
  return {
    ...
    addWatchFile(id) {
      options.addWatchFile((0, import_path6.resolve)(import_process.default.cwd(), id));
    },
    emitFile(emittedFile) {
      const outFileName = emittedFile.fileName || emittedFile.name;
      if (emittedFile.source && outFileName) {
...
// src/webpack/index.ts
var TRANSFORM_LOADER2 = (0, import_path7.resolve)(
  __dirname,
  false ? "../../dist/webpack/loaders/transform" : "webpack/loaders/transform"
);
var LOAD_LOADER2 = (0, import_path7.resolve)(
  __dirname,
